 ...
 * - enable eslint-plugin-regexp
 * - enable eslint-plugin-regexp recommended rules
 * - enable eslint-plugin-import-x
 * - enable keenghost recommended rules
 */
const useBasePreset: () => Linter.Config[] = () => {
